                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <div class="dropdown-menu" role="menu">
                                        <a class="dropdown-item" onclick="onClickUpdateTicketStatus()">Open</a>
                                        <a class="dropdown-item" onclick="onClickUpdateTicketStatus()">Pending</a>
                                        <a class="dropdown-item" onclick="onClickUpdateTicketStatus()">Closed</a>
                                    </div>
                                </div>
                            </td>
                            <td>May 09, 2025</td>
